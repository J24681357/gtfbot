...
module.exports.ssrxracelength = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  ...
  var showcar =
    ...
    emote.fpp +
    " | " +
    racesettings["misc"]["car"]["tires"]["current"]
      .split(" ")
      .map(x => x[0])
      .join("") +
    emote.tire +
...
module.exports.ssrxmiandresults = function ([speedmph, speedkmh], user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  ...
  var results2 = "**Top Speed:** " + speedmph + " MPH / " + speedkmh + " KMH" + "\n" + "**Car:** " + racesettings["misc"]["car"]["name"] + " **" + racesettings["misc"]["car"]["fpp"] + emote.fpp + "**";
  return results2;
};
////CAREER///
module.exports.careerracelength = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  var showcar =
    "\n**🚘 " +
    racesettings["misc"]["car"]["name"] +
    " " +
...
module.exports.arcaderacelength = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  var showcar = "";
...
module.exports.driftracelength = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  var showcar = "";
  if (racesettings["misc"]["car"].length != 0) {
    var showcar =
      "\n**🚘 " +
...
module.exports.driftsection = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata, last) {
  ...
  var silver = Math.ceil((racesettings["km"] * 0.9 * 2000) / 100) * 100;
  var bronze = Math.ceil((racesettings["km"] * 0.8 * 2000) / 100) * 100;
...
module.exports.driftresults = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  stats.addmileage(racesettings["km"], racesettings["mi"], userdata);
  stats.addtotalmileage(racesettings["km"], racesettings["mi"], userdata);
  var medal = "COMPLETE";
...
module.exports.onlineracelength = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, embed, msg, args, checkpoint, userdata) {
  var showcar = "";
  var fppavg = 0;
...
////MISC
module.exports.createfinalreactions = function (user, racedetails, racesettings, finalgrid, startingrace, racefinished, results2, embed, msg, args, checkpoint, userdata) {
  function func() {
    require(gtf.REPLAY).savem(racesettings["title"], results2, racedetails, "__Starting Grid - " + racesettings["category"] + " | " + racesettings["grid"] + " cars" + "__" + "\n" + finalgrid + "\n", userdata);
