...
module.exports = {
  ...
  usedinlobby: false,
  description: [
    "!settings - Displays the settings for GTF, including your current preferences.",
    '!settings ["setting"] - Displays a list of preferences for that type of ["setting"].',
    '!settings ["setting"] [ (number)] - Sets the preference for the [(number)] associated with the list in its ["setting"]',
  ],
  execute(msg, query, userdata) {
    ...
    if (!checked) {
      var m = ["KM", "MI"];
      var list = [
        ["__**Mileage Units**__ - !settings units [(number)]\r" + m[stats.setting("MILEAGE", userdata)], " "],
