...
module.exports = {
  ...
  execute(msg, query, userdata) {
    ...
    prizes.push(["CREDITS", { id: -1, name: "5,000" + emote.credits + " Prize", item: 5000, author: "DAILY WORKOUT", isgift: false }]);
    prizes.push(["CREDITS", { id: -1, name: "10,000" + emote.credits + " Prize", item: 10000, author: "DAILY WORKOUT", isgift: false }]);
    prizes.push(["CREDITS", { id: -1, name: "20,000" + emote.credits + " Prize", item: 20000, author: "DAILY WORKOUT", isgift: false }]);

    var car = require(gtf.CARS).random({}, 1)[0];
    prizes.push(["CAR", { id: -1, name: car["name"] + " " + car["year"], item: car, author: "DAILY WORKOUT", isgift: false }]);
